...
<form action="{{route('employees.update',$employee->id) }}" method="POST">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Role</strong>
                <input type="text" name="role" value="{{$employee->role}}" class="form-control" placeholder="Role">
            </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Salary</strong>
                <input type="text" name="salary" value="{{$employee->name}}" class="form-control" placeholder="Salary">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
